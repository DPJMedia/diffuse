...
import { features as featureContent } from '@/lib/content/diffuse'

// Feature copy lives in lib/content/diffuse.ts (shared with the MCP server and llms.txt).
// Icons are presentational and stay here, keyed to each feature by key.
...
const features = featureContent.map((feature) => ({
  title: feature.title,
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-12 md:mb-16 px-4">
            ...
            <p className="text-body-lg text-medium-gray max-w-2xl mx-auto">
              Mix any sources, keep the context, and stay in editorial control. Teams and publishing when you need them.
            </p>
          </motion.div>
