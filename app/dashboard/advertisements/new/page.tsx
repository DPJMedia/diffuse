  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-200px)]">
      <div className="w-full max-w-2xl">
        <h1 className="text-heading-lg text-secondary-white mb-8">Create an advertisement</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describe the product or service to promote..."
            />
          </div>
                  ...
                  <div className="flex-1 border-l border-white/10 pl-6">
                    {allWorkspaces.length === 0 ? (
                      <p className="text-body-sm text-medium-gray">
                        No organizations available. Join an organization to share this advertisement.
                      </p>
                    ) : (
