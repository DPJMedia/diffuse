  ...
  const fetchProjects = useCallback(async () => {
    ...
    try {
      ...
      const [inputsResult, outputsResult, creatorsResult, orgsResult] = await Promise.all([
        // Get all inputs for all projects (excluding images)
        projectIds.length > 0
          ? supabase
      ...
      // Count inputs per project (excluding cover_photo and image types)
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        <h1 data-walkthrough="page-title" className="text-heading-lg text-secondary-white">Projects</h1>
        ...
        <div className="hidden md:flex items-center gap-3">
          {showBulkActions ? (
            ...
            <>
              ...
              <CreateProjectButton className="w-60 flex-shrink-0" />
            </>
          )}
        </div>
      </div>
